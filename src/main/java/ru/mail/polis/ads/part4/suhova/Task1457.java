...
public class Task1457 {
    /*
    Task 5: https://www.e-olymp.com/ru/submissions/5893072
     */

    private static boolean can = true;
    private static int M;

    private static void solve(final Task1457.FastScanner in, final PrintWriter out) {
        int n = in.nextInt();
        M = in.nextInt();
        int[] a = new int[n];
        for (int i = 0; i < n; i++) {
    ...
    public static void main(final String[] arg) {
        final Task1457.FastScanner in = new Task1457.FastScanner(System.in);
